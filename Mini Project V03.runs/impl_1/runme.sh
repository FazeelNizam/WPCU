...
HD_PWD='C:/HDL/Mini Project V03/Mini Project V03.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log WPCU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source WPCU.tcl -notrace
