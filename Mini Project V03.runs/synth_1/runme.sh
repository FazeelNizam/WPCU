...
HD_PWD='C:/HDL/Mini Project V03/Mini Project V03.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log WPCU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source WPCU.tcl
